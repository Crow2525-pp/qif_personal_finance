...
-- Test 1: fct_transactions.account_key references valid dim_accounts.account_key
...
-- Test 2: fct_transactions.category_key references valid dim_categories.category_key  
...
-- Test 3: fct_daily_balances.account_key references valid dim_accounts.account_key
