...
[
  ...
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/executive-dashboard.json (timepicker block, defaults); reporting queries already windowed after task 41",
    "effort": "small",
    "status": "done",
  ...
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary; platform/grafana/provisioning/dashboards/executive-dashboard.json (Key Executive KPIs, Month-over-Month Rate Changes tables)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary; reporting.rpt_outflows_insights_dashboard; platform/grafana/provisioning/dashboards/executive-dashboard.json (Savings & Expense Performance, MoM Rate Changes, Data Quality Callouts, related stats)",
    "effort": "small",
    "status": "done",
  ...
  },
  {
    ...
    "scope": "reporting.rpt_outflows_insights_dashboard; reporting.viz_uncategorized_transactions_with_original_memo; platform/grafana/provisioning/dashboards/executive-dashboard.json (Data Quality Callouts, Top Uncategorized Merchants, AI Financial Insights)",
    "effort": "medium",
    "status": "done",
  ...
  },
  {
    ...
    "scope": "reporting.rpt_cash_flow_analysis; platform/grafana/provisioning/dashboards/executive-dashboard.json (Monthly Financial Snapshot stat)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary; platform/grafana/provisioning/dashboards/executive-dashboard.json (Savings & Expense Performance bar gauge)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary (plus transfers source); platform/grafana/provisioning/dashboards/executive-dashboard.json (Cash Flow Drivers panel)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_household_net_worth; reporting.rpt_cash_flow_analysis snapshot fields; platform/grafana/provisioning/dashboards/executive-dashboard.json (Asset & Liability Snapshot, Monthly Financial Snapshot)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_cash_flow_analysis + platform/grafana/provisioning/dashboards/executive-dashboard.json (Cash Flow Trend panel)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary or new rpt_monthly_pacing; platform/grafana/provisioning/dashboards/executive-dashboard.json (replace WTD panel)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/executive-dashboard.json layout",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_outflows_insights_dashboard; platform/grafana/provisioning/dashboards/executive-dashboard.json (Data Quality Callouts)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/executive-dashboard.json (Executive Summary text panel)",
    "effort": "tiny",
    "status": "pending"
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/01-executive-overview-mobile.json",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_family_essentials; platform/grafana/provisioning/dashboards/executive-dashboard.json (Family Essentials stat panel)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_household_net_worth; platform/grafana/provisioning/dashboards/executive-dashboard.json (Asset & Liability Snapshot panel)",
    "effort": "small",
    "status": "pending"
  },
  {
  ...
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary; platform/grafana/provisioning/dashboards/executive-dashboard.json (Savings & Expense Performance)",
    "effort": "small",
    "status": "pending"
  },
  {
  ...
  },
  {
    ...
    "scope": "reporting.viz_uncategorized_transactions_with_original_memo; platform/grafana/provisioning/dashboards/executive-dashboard.json (Top Uncategorized Merchants table)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_weekly_spending_pace; platform/grafana/provisioning/dashboards/executive-dashboard.json (Week-to-Date Spending Pace stat)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_emergency_fund_coverage; platform/grafana/provisioning/dashboards/executive-dashboard.json (Emergency Fund Coverage gauge)",
    "effort": "small",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.rpt_monthly_budget_summary (plus internal_transfers source) and platform/grafana/provisioning/dashboards/executive-dashboard.json (replace MoM Cash Changes panel)",
    "effort": "medium",
    "status": "pending"
  },
  {
  ...
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/executive-dashboard.json; Grafana public dashboards/plugin settings",
    "effort": "small",
    "status": "pending",
  ...
  },
  {
    ...
    "scope": "reporting.rpt_family_essentials; reporting.rpt_emergency_fund_coverage; reporting.rpt_weekly_spending_pace; platform/grafana/provisioning/dashboards/executive-dashboard.json",
    "effort": "small",
    "status": "pending",
  ...
  },
  {
    ...
    "scope": "platform/grafana/provisioning/dashboards/executive-dashboard.json (Executive Summary, KPI tables)",
    "effort": "tiny",
    "status": "pending"
  },
  {
    ...
    "scope": "reporting.viz_uncategorized_transactions_with_original_memo; platform/grafana/provisioning/dashboards/executive-dashboard.json (Top Uncategorized Merchants)",
    "effort": "small",
    "status": "pending"
  }
]
